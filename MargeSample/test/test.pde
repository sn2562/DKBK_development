...
void setup() {
	...
	FilePath1="/Users/kawasemi/Documents/processing2014/DKBK_development/MargeSample/test/data"+"/13_40_51.dsd";
	...
	for (int i=0; i<fp.length; i++) {
		...
		fp[i] = "/Users/kawasemi/Documents/processing2014/DKBK_development/MargeSample/test/data"+"/body"+i+".dsd";
		println("fp " +i+"  "+fp[i]);
